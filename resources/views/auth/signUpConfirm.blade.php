...
<body>
<div class="container">  
  <form id="contact" action="/signUp/confirm/{{$id_user}}" method="post">
  {{ csrf_field() }} 
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="alamat_lengkap" name="alamat_lengkap" placeholder="Alamat Lengkap"required>
  </div>
  ...
  <a href="/store" class="btn btn-success">To Store</a>
  </form>
